...
@section('foot')
    <script>
        ...
        const data_url = "{{ route('groups.index') }}";
    </script>
    <script src="{{ env('APP_URL') }}/assets/plugins/custom/datatables/datatables.bundle.js"></script>
    <script src="{{ env('APP_URL') }}/assets/js/custom/group/index.js"></script>
@endsection

@section('content')
    <!--begin::Content container-->
    <div id="kt_app_content_container" class="app-container container-fluid">
        <h2 class="py-10">All Groups</h2>
        <!--begin::Card-->
        <div class="card">
            <!--begin::Card header-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-primary" id="create_button">
                            <i class="ki-outline ki-plus fs-2"></i>Create Group</button>
                        <!--end::Add user-->
                    </div>
                    <!--end::Toolbar-->
                ...
                <table id="kt_datatable" class="table align-middle table-row-dashed fs-6 gy-5">
                    <thead>
                        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Leader Name</th>
                            <th class="min-w-125px">Leader Mobile</th>
                            <th class="min-w-125px">Total Member</th>
