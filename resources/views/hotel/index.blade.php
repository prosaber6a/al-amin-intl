...
@section('foot')
    <script>
        ...
        const data_url = "{{ route('hotels.index') }}";
    </script>
    <script src="{{ env('APP_URL') }}/assets/plugins/custom/datatables/datatables.bundle.js"></script>
    <script src="{{ env('APP_URL') }}/assets/js/custom/hotel/index.js"></script>
@endsection
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-primary" id="create_button">
                            <i class="ki-outline ki-plus fs-2"></i>Add Hotel</button>
                        <!--end::Add user-->
                    </div>
                    <!--end::Toolbar-->
                ...
                <table id="kt_datatable" class="table align-middle table-row-dashed fs-6 gy-5">
                    <thead>
                        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Room Capacity</th>
