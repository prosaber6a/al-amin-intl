...
var KTHotels = (function () {
    ...
    var modal_show = (modal_props) => {
        ...
        if (modal_props.action === "update") {
            ...
            $("#modal_form [name='location']").val(modal_props.data.location);
            $("#modal_form [name='room_type']").val(modal_props.data.room_type);
            $("#modal_form [name='room_capacity']").val(
                modal_props.data.room_capacity
            );
            $("#modal_form [name='price_per_night']").val(
                modal_props.data.price_per_night
            );
        }
                    ...
                    if (status == "Valid") {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                //set message
                                let message =
                                    "Hotel info inserted successfully";
                                if (
