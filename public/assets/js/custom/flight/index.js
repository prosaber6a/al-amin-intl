...
var KTFlights = (function () {
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach((d) => {
            ...
            d.addEventListener("click", function (e) {
                ...
                // Get customer name
                const flightNo = parent.querySelectorAll("td")[0].innerText;
                ...
                Swal.fire({
                    text: "Are you sure you want to delete " + flightNo + "?",
                    icon: "warning",
    ...
    var initModal = () => {
        ...
        // init date picker
        $("[name='departure']").flatpickr({
            enableTime: true,
            dateFormat: "Y-m-d H:i",
        });

        $("[name='arrival']").flatpickr({
            enableTime: true,
            dateFormat: "Y-m-d H:i",
        });
    ...
    var modal_show = (modal_props) => {
        ...
        if (modal_props.action === "update") {
            ...
            $("#modal_form [name='flight_no']").val(modal_props.data.flight_no);
            $("#modal_form [name='airline']").val(modal_props.data.airline);
            $("#modal_form [name='from']").val(modal_props.data.from);
            $("#modal_form [name='to']").val(modal_props.data.to);
            $("#modal_form [name='departure']").val(modal_props.data.departure);
            $("#modal_form [name='arrival']").val(modal_props.data.arrival);
                ...
                departure: {
                    validators: {
                        ...
                        date: {
                            ...
                            message:
                                "The value is not a valid date. The format should be YYYY-MM-DD HH:mm",
                        },
                    },
                },
                arrival: {
                    ...
                    if (status == "Valid") {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                //set message
                                let message =
                                    "Flight info inserted successfully";
                                if (
